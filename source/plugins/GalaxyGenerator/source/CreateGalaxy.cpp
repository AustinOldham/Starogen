...
vector<CreateGalaxy::StarInfo> CreateGalaxy::readStarFile(string fileName) {
	cout << "herersf" << endl;
	vector<CreateGalaxy::StarInfo> myStarList;
	...
	for (auto& element : j) {
		// cout << element["name"] << '\n';
		myStarList.push_back(CreateGalaxy::StarInfo());

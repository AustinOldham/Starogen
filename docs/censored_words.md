Starogen uses completely random gibberish to name stars, planets, etc. Since this could create words that are offensive, you can add a filter to prevent them from being generated.
